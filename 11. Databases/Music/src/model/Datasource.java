...
public class Datasource {
    ...
    //C:\Users\Aleksandra\Desktop\Java Programming Masterclass\Music

    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\Aleksandra\\Desktop\\Java Programming Masterclass\\Music\\" + DB_NAME;
    ...
    public static final String QUERY_ARTIST_FOR_SONG_START =
            "SELECT " + TABLE_ARTISTS + "." + COLUMN_ARTIST_NAME + ", " +
                    ...
                    TABLE_SONGS + "." + COLUMN_SONG_ALBUM + " = " + TABLE_ALBUMS + "." + COLUMN_ALBUMS_ID +
                    " INNER JOIN " + TABLE_ARTISTS + " ON " +
                    TABLE_ALBUMS + "." + COLUMN_ALBUMS_ARTIST + " = " + TABLE_ARTISTS + "." + COLUMN_ARTIST_ID +
    ...
    public static final String CREATE_ARTIST_FOR_SONG_VIEW = "CREATE VIEW IF NOT EXISTS " +
            ...
            TABLE_ALBUMS + "." + COLUMN_ALBUMS_NAME + " AS " + COLUMN_SONG_ALBUM + ", " +
    ...
    public List<SongArtist> querySongInfoView(String title) {
        ...
        try {
            ...
            System.out.println("Query filed: " + e.getMessage());
            return null;
        }
    }
    ...
    public void insertSong(String title, String artist, String album, int track) {
        ...
        try {
            ...
            try {
                ...
                System.out.println("Ups: " + e2.getMessage());
            }
        } finally {
            try {
